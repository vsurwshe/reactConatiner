const INITIAL_STATE = {
  ...
  invoiceDate: [],
  invoiceDeleteResult: "",
  // --------------- Profile Invoice State
  profileInvoices: [],
  profileInvoiceResult: [],
  updateProfileInvoiceResult: [],
  profileInvoiceDeleteResult: "",
};
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    // -------------- Profile Invoice Actions
    case "LOAD_PROFILE_INVOICE":
      return {
        ...state,
        profileInvoices: action.profile_invoices,
      };
    case "RESULT_SAVED_PROFILE_INVOICE":
      return {
        ...state,
        profileInvoiceResult: action.profile_invoice_result,
      };
    default:
      return state;
  }
