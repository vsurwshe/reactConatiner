...
export class ProfileInvoiceTable extends Component {
    componentDidMount() {
            ...
            columnDefs: [
                ...
                // },
                {
                    ...
                    "data": function (row, type, val, meta) {
                        return row[5] !== "null" ? "<button class='verifyButton' style='background-color: green; border-radius: 0.25em' >View Profile Invoice</button>" : "";
                    },
                    "createdCell": (td, cellData, rowData, row, col) => {
                        $(td).click(e => {
                            this.props.handelShowInvoice(rowData)
                        })
                    },
                },
                // {
